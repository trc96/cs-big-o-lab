...
function findABetterFourth(numbers) {
  return numbers[3]
}
O(1)
...
function getNumbersSquaredBetter(nums) {
  let answers = []

  for (let i = 0; i < nums.length; i++) {
    answers.push(nums[i] * nums[i])
  }
...
// ANSWER: Both have a fixed amount of data based on the length of the array they take in.
